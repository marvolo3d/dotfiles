...
if [[ `uname` == 'Darwin' ]]; then
    ...
    function FTPmount {
        curlftpfs ftp://tomnorman.ca /mnt/tomnorman_ca/goodies -o user=goodies@tomnorman.ca:***REMOVED***
        curlftpfs ftp://tomnorman.ca /mnt/tomnorman_ca/the_abyss -o user=marvolo@tomnorman.ca:***REMOVED***
        curlftpfs ftp://tomnorman.ca /mnt/tomnorman_ca/public -o user=public@tomnorman.ca:***REMOVED***
    }
